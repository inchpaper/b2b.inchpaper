...
import { X, Plus, Edit2, Trash2, ExternalLink, Image as ImageIcon, Link as LinkIcon, CheckCircle2, AlertCircle, Eye, RefreshCw, Key, ShieldCheck } from 'lucide-react';
                  ...
                  <div>
                    ...
                    <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden shadow-sm p-3.5">
                      <div className="relative aspect-[16/10] bg-stone-100 rounded-xl overflow-hidden mb-3">
                        <img
                          src={editingCatalog.imageUrl || PRESET_IMAGES[0].url}
                          alt="Catalog preview"
